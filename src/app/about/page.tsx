...
export default function Page() {
  return (
    <SectionWrapper>
      ...
      <p className="text-black dark:text-gray-200 mt-3 text-base font-light">
        My journey into development started in 2020 when I became fascinated by
        how software powers the world around us. Over the years, I have built{" "}
        <b>
      ...
      <ul className="text-black dark:text-gray-200 mt-3 text-base list-disc pl-5">
        <li>
          <b>Problem Solver:</b> I enjoy tackling complex challenges and finding
          elegant solutions.
        </li>
        <li>
        ...
        <li>
          <b>Security-First Approach:</b> I ensure that applications are secure
          from the ground up.
        </li>
        <li>
      ...
      <p className="text-black dark:text-gray-200 mt-3 text-base font-light">
        ...
        movies like <i>Allied (2016)</i> and <i>The Gorge (2025)</i>, as well as
        playing video games like <i>Europa Universalis IV</i> and <i>Dota 2</i>.
      </p>
    </SectionWrapper>
  );
}
