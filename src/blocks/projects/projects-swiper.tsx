...
export default function ProjectsSwiper() {
  ...
  return (
    <div className="w-screen h-screen bg-background-light dark:bg-background-dark text-foreground-dark dark:text-foreground-light">
      <Swiper
        centeredSlides
        autoplay={{
          delay: 5000,
      ...
      >
        {projects.map((project) => (
          <SwiperSlide key={project.id}>
            <div className="w-full h-full bg-cover bg-center relative flex items-center justify-start">
              <div className="absolute inset-0 backdrop-blur-sm bg-background-light/60 dark:bg-background-dark/60" />
                ...
                <div className="flex gap-4">
                  {project.liveUrl && (
                    <Link
                      ...
                      className="px-5 py-2 rounded-lg text-sm font-semibold transition bg-foreground-light text-background-dark hover:bg-foreground-light/90 dark:bg-foreground-dark dark:text-background-light dark:hover:bg-foreground-dark/90"
                    >
                      Live Site
                    </Link>
                  )}
                  {project.githubUrl && (
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-5 py-2 rounded-lg text-sm font-semibold transition border border-foreground-light dark:border-foreground-dark hover:bg-foreground-light hover:text-background-dark dark:hover:bg-foreground-dark dark:hover:text-background-light"
                    >
                      GitHub
                    </Link>
                  )}
